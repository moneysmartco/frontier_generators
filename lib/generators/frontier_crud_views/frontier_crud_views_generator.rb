...
class FrontierCrudViewsGenerator < Frontier::Generator
  ...
  def scaffold
    unless model.skip_ui?
      [
        [model.view_paths.index_path, "index.html.slim", model.show_index?],
        [model.view_paths.form_path, "_form.html.slim", model.show_create? || model.show_update?],
        [model.view_paths.new_path, "new.html.slim", model.show_create?],
        [model.view_paths.edit_path, "edit.html.slim", model.show_update?]
